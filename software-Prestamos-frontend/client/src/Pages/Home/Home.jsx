...
const Home = () => {
    ...
    return (
        <div className='bg-white xl:w-full w-[340px] '>
            <div className="p-4 space-y-6 -ml-5 xl:ml-0">
                <div className="grid grid-cols-1 sm:grid-cols-2  xl:ml-0 md:grid-cols-4 mb-10 gap-5">
                    {stats.map((stat, index) => (
                        <div key={index} className="flex flex-col p-4 bg-white xl:w-full w-[340px] rounded-xl shadow-md">
                ...
                {/* <div className="bg-white p-6 rounded-xl drop-shadow-xl ">
                    ...
                    <div className="overflow-x-auto w-full mt-4 ">
                        <div className="overflow-y-auto max-h-[300px]">
                            <table className=" bg-white border-collapse table-auto w-full">
